...
currLists = ["ETH-CVC", "ETH-BAT", "ETH-TKN", "ETH-FUN", "ETH-GNO", "ETH-REP", "ETH-ANT"]       #The order of the totalMarkets in totalMarkets changes, so I just have to define the appendages myself unless I want to do all totalMarkets
